...
private _pantheraArray = ["Land_MarketShelter_F"];
private _spawnBuildings = [[["Altis", _altisArray], ["Tanoa", _tanoaArray], ["Panthera3", _pantheraArray]]] call TON_fnc_terrainSort;
