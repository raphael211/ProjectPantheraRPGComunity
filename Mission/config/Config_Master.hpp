...
/* System Settings */
    ...
    bank_cop = 700000; //Amount of cash in bank for new cops
    bank_civ = 3000000; //Amount of cash in bank for new civillians
    bank_med = 650000; //Amount of cash in bank for new medics
